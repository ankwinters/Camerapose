...
#declare T_NewsTop=texture{pigment{image_map{png "top"}} finish{F_Newspaper}}
#declare T_NewsFront=texture{pigment{image_map{png "middle"}} finish{F_Newspaper}} // should be different
#declare T_NewsBottom=texture{pigment{image_map{png "bottom"}} finish{F_Newspaper}} // should be different
...
// 170309 add
#declare T_Left=texture{
    pigment{image_map{png "posterl"}}
    //normal{bozo 0.2}
    finish{ambient 0 diffuse 0.6}
    //finish{ambient 0 diffuse 0.8 specular 0.1 roughness 0.05 }
}

#declare T_Right=texture{
    pigment{image_map{png "posterr"}}
    finish{ambient 0 diffuse 0.6}
}

#declare T_Back=texture{
...
#declare NVM2=object{mNewsVM(xVMBox,yVMBox,zVMBox,yrtVMBox,eVM,T_PaintHead,T_PaintBox,T_NewsTop,T_NewsFront,T_NewsBottom,T_Left,T_Right,T_Back)}
